...
*-- Project       : EM6819
*--
*-- Creation Date : 27.04.2007 (dd:mm:yy)
*--
*-- Description   : Interrupts and Events Masking Header File
*--
*-------------------------------------------------------------------------------
*--                          History
*-------------------------------------------------------------------------------
...
#define Dis_IRQ_Port1()           ClrBit ( RegInt1Msk, Int1MskPort_1 )
...
#define ClrPending_IRQ_SlpCnt()       ClrBit ( RegInt2Sts, Int2StsSlpCnt )
